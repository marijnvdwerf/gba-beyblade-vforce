...
- Batch of four smallest yellows (luna, one each, no park commits):
  ...
  **725 C / 300 asm / 71%.** Running: sub_805E8D8 (camera, MATCHED c9af6538 after replacing a `(p - (i * -1))` lever with an in-argument record-alias assignment — sanctioned TODO to be added at merge; review running), renderActor (actor), sub_804EA88 (particle),
