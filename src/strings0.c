...
const unk8 Str_86FCED8[]
    = "error allocating space for DisplayStrings in creditsFrontendHandler()\n";
...
const unk8 Str_86FD214[]
    = "error allocating memory for strings in collectionListFrontendHandler()\n";
...
const unk8 Str_8729504[]
    = "Warning; unable to locate start points for level, no supplied collision "
      "data, in initRiders()\n";
...
const unk8 Str_872C99C[]
    = "No AI collision data was provided for this level in initAIManagement()\n";
