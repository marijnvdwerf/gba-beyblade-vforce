...
extern unk32 loadLevelGeometry(u16);
...
void initRiders(void)
{
    ...
    GetLevelDescriptionNo();
    {
        ...
        StoreMetadataAddr(&geometry, levelDescription->unk2C);
    }
            ...
            if ((initialized & 1) == 0) {
                if (_gameData->unk1618 != 0 && isMultiplayer() != 0) {
                    ...
                    if (multiplayerLineIndex >= 0) {
                        ...
                        x = ((GeometryPoint*)geometry.unk4)[multiplayerLine->pointIndex].x >> 3;
                        y = ((GeometryPoint*)geometry.unk4)[multiplayerLine->pointIndex].y >> 3;
                        z = ((GeometryPoint*)geometry.unk4)[multiplayerLine->pointIndex].z >> 3;
                    } else {
